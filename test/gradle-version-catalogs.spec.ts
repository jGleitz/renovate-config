...
describe("Gradle version catalogs", () => {
  test("assigns correct semantic commit types to dependencies from different catalogs", async ({
    renovate,
  }) => {
    ...
    const jacksonBranch = branches.find((b) =>
      b.updates.some((u) => u.depName === "com.fasterxml.jackson.core:jackson-databind"),
    )
    ...
    const slf4jBranch = branches.find((b) =>
      b.updates.some((u) => u.depName === "org.slf4j:slf4j-api"),
    )
    ...
    const commonsLangBranch = branches.find((b) =>
      b.updates.some((u) => u.depName === "org.apache.commons:commons-lang3"),
    )
    ...
    const junitBranch = branches.find((b) =>
      b.updates.some((u) => u.depName === "org.junit.jupiter:junit-jupiter"),
    )
    ...
    const mockitoBranch = branches.find((b) =>
      b.updates.some((u) => u.depName === "org.mockito:mockito-core"),
    )
    ...
    const assertjBranch = branches.find((b) =>
      b.updates.some((u) => u.depName === "org.assertj:assertj-core"),
    )
    ...
    const detektBranch = branches.find((b) =>
      b.updates.some((u) => u.depName === "io.gitlab.arturbosch.detekt"),
    )
    ...
    const kotlinBranch = branches.find((b) =>
      b.updates.some((u) => u.depName === "org.jetbrains.kotlin.jvm"),
    )
    ...
    const develocityBranch = branches.find((b) =>
      b.updates.some((u) => u.depName === "com.gradle.develocity"),
    )
